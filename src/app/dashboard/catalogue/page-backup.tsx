...
import { ToolSwitcher } from '@/components/dashboard/ToolSwitcher'
import {
  Card,
  CardContent,
  CardDescription,
...
export default function DashboardPage() {
  ...
  return (
    <>
      <Header title="Catalogue Dashboard" />
              ...
              <div className="pb-6 text-white">
                <div className="mb-6 flex flex-col gap-8">
                  <div>
                    ...
                    >
                      Manage your product catalogues with AI-powered tools. Create stunning catalogues, collaborate with your team, and export professional PDFs.
                    </p>

        ...
        payload => {
          ...
          if (payload.eventType === 'UPDATE') {
            toast({
              ...
              description:
                'This catalogue has been modified by another user. Click to reload.',
              duration: 10000,
            })
          }
        }
      ...
      .on(
        ...
        payload => {
          ...
          toast({
            ...
            description:
              (eventMessages[payload.eventType] ||
                'Category changed by another user.') + ' Click to reload.',
            duration: 10000,
          })
        }
      )
      ...
      .on(
        ...
        payload => {
          ...
          toast({
            ...
            description:
              (eventMessages[payload.eventType] ||
                'Product changed by another user.') + ' Click to reload.',
            duration: 10000,
          })
        }
      )

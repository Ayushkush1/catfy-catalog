...
import { ChevronRight, Eye, EyeOff, Lock, Unlock, Layers, FileText } from 'lucide-react';
...
export const StatusBar: React.FC<StatusBarProps> = ({
  ...
  return (
    <div className={`bg-white border-t border-gray-200 px-4 py- flex items-center justify-between text-sm ${className}`}>

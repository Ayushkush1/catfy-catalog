...
import { createTemplate, createContainer, createHeading, createText, createImage, createButton, createGrid } from '../utils/template-builder';
...
export const furnitureCatalogTemplate: Template = createTemplate()
  ...
  .setDescription('A 4-page furniture catalog: Cover, Intro, Products, and Contact pages')
  .setCategory('catalog')
  ...
  .setMultiPageData([
    // PAGE 1: COVER PAGE
    {
      ...
      data: JSON.stringify({
        ...
        "cover-main-layout": {
          ...createContainer('cover-main-layout', {
            display: "flex",
            width: "100%",
            flex: 1,
            position: "relative"
        ...
        "cover-left-section": {
          ...createContainer('cover-left-section', {
            flex: "1",
            padding: "80px 60px",
            display: "flex",
            flexDirection: "column",
        ...
        "cover-subtitle": {
          ...createContainer('cover-subtitle', {
        ...
        "cover-orange-accent": {
          ...createContainer('cover-orange-accent', {
            width: "120px",
            backgroundColor: "#ff6b35",
            position: "relative",
            zIndex: 5
          }, "Cover Orange Accent", [], "cover-main-layout")
        },
        "cover-right-section": {
          ...createContainer('cover-right-section', {
            flex: "1",
            position: "relative",
            backgroundColor: "#2a2a2a",
            display: "flex",
        ...
        "cover-image-container": {
          ...createContainer('cover-image-container', {
            position: "relative",
            width: "80%",
            height: "80%",
            display: "flex",
        ...
        "new-arrivals-badge": {
          ...createContainer('new-arrivals-badge', {
            position: "absolute",
            bottom: 20,
            right: 20,
            backgroundColor: "#ff6b35",
    ...
    // PAGE 2: INTRO PAGE
    {
      ...
      data: JSON.stringify({
        ...
        "intro-image-section": {
          ...createContainer('intro-image-section', {
            flex: "1",
            minHeight: "100vh",
            position: "relative",
            overflow: "hidden"
        ...
        "intro-content-section": {
          ...createContainer('intro-content-section', {
            flex: "1",
        ...
        "intro-brand-section": {
          ...createContainer('intro-brand-section', {
    ...
    // PAGE 3: PRODUCT PAGE
    {
      ...
      data: JSON.stringify({
        ...
        "product-header": {
          ...createContainer('product-header', {
            marginBottom: 60,
            textAlign: "center"
          }, "Product Header", [
            "product-page-title",
        ...
        "product-item-1": {
          ...createContainer('product-item-1', {
            backgroundColor: "#ffffff",
            borderRadius: 8,
            overflow: "hidden",
        ...
        "product-1-info": {
          ...createContainer('product-1-info', {
            padding: 20
          }, "Product 1 Info", [
            "product-1-name",
            "product-1-price",
        ...
        "product-item-2": {
          ...createContainer('product-item-2', {
            backgroundColor: "#ffffff",
            borderRadius: 8,
            overflow: "hidden",
            boxShadow: "0 2px 8px rgba(0, 0, 0, 0.1)"
        ...
        "product-2-info": {
          ...createContainer('product-2-info', {
            padding: 20
          }, "Product 2 Info", [
            "product-2-name",
            "product-2-price",
        ...
        "product-item-3": {
          ...createContainer('product-item-3', {
            backgroundColor: "#ffffff",
            borderRadius: 8,
            overflow: "hidden",
            boxShadow: "0 2px 8px rgba(0, 0, 0, 0.1)"
        ...
        "product-3-info": {
          ...createContainer('product-3-info', {
            padding: 20
          }, "Product 3 Info", [
            "product-3-name",
            "product-3-price",
        ...
        "product-footer": {
          ...createContainer('product-footer', {
            display: "flex",
            justifyContent: "space-between",
            alignItems: "center",
            paddingTop: 40,
    ...
    // PAGE 4: CONTACT PAGE
    {
      ...
      data: JSON.stringify({
        ...
        "contact-image-section": {
          ...createContainer('contact-image-section', {
            flex: "1",
            minHeight: "100vh",
            position: "relative",
            overflow: "hidden"
        ...
        "contact-quote-overlay": {
          ...createContainer('contact-quote-overlay', {
            position: "absolute",
            bottom: 60,
            left: 60,
            right: 60,
        ...
        "contact-info-section": {
          ...createContainer('contact-info-section', {
            flex: "1",
            backgroundColor: "#f8f8f8",
            padding: "80px 60px",
            display: "flex",
        ...
        "contact-details": {
          ...createContainer('contact-details', {
            marginBottom: 60
          }, "Contact Details", [
        ...
        "contact-address-section": {
          ...createContainer('contact-address-section', {
            marginBottom: 40
          }, "Contact Address Section", [
        ...
        "contact-phone-section": {
          ...createContainer('contact-phone-section', {
            marginBottom: 40
          }, "Contact Phone Section", [
            "contact-phone-label",
            "contact-phone-value"
        ...
        "contact-email-section": {
          ...createContainer('contact-email-section', {
            marginBottom: 40
          }, "Contact Email Section", [
            "contact-email-label",
            "contact-email-value"
        ...
        "contact-website-section": {
          ...createContainer('contact-website-section', {
            marginBottom: 40
          }, "Contact Website Section", [
        ...
        "contact-social": {
          ...createContainer('contact-social', {
            display: "flex",
            gap: 20,
            marginBottom: 60
          }, "Contact Social", [
        ...
        "social-instagram": {
          ...createContainer('social-instagram', {
            width: 40,
            height: 40,
        ...
        "social-facebook": {
          ...createContainer('social-facebook', {
            width: 40,
            height: 40,
            backgroundColor: "#2c3e50",
            borderRadius: "50%",
        ...
        "social-twitter": {
          ...createContainer('social-twitter', {
            width: 40,
            height: 40,
            backgroundColor: "#2c3e50",
            borderRadius: "50%",
        ...
        "contact-footer": {
          ...createContainer('contact-footer', {
            display: "flex",
            justifyContent: "space-between",
            alignItems: "center",
            paddingTop: 40,

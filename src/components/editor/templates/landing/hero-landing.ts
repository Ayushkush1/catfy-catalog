...
import { createTemplate, createContainer, createHeading, createText, createButton } from '../utils/template-builder';
...
export const heroLandingTemplate: Template = createTemplate()
  ...
  .setDescription('A modern hero section with heading, description, and call-to-action button')
  .setCategory('landing')
  ...
  .setData({
    "ROOT": {
      ...createContainer('ROOT', {
        ...
        alignItems: "center",
        textAlign: "center"
      }, "Container", ["hero-heading", "hero-description", "hero-button"])
    },
    "hero-heading": {
      ...createHeading(

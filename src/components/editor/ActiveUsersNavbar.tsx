...
export function ActiveUsersNavbar({ users, isTracking }: ActiveUsersNavbarProps) {
                    ...
                    <div className="flex items-center -space-x-2">
                        {displayUsers.map((user, index) => (
                            ...
                            >
                                ...
                                <Circle
                                    className="h-2 w-2 absolute -bottom-0.5 -right-0.5 fill-green-500 text-green-500 animate-pulse"
                                />
                            </div>
                        ))}
                        {remainingCount > 0 && (
            ...
            <DropdownMenuContent className="w-72 p-3" align="end">
                <div className="space-y-3">
                    <div className="flex items-center justify-between">
                        <h4 className="text-sm font-semibold text-gray-900">Active Users</h4>
                        ...
                        {users.map((user) => (
                            ...
                            >
                                <div className="relative">
                                    ...
                                    <Circle
                                        className="h-2.5 w-2.5 absolute -bottom-0.5 -right-0.5 fill-green-500 text-green-500 animate-pulse"
                                    />
                                </div>

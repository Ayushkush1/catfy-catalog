...
export const ContainerBlock: React.FC<Partial<ContainerBlockProps> & { children?: React.ReactNode }> = (props) => {
  const {
      ...
      {hasChildren ? (
        ...
        >
          <div>
            ...
            <div style={{ fontWeight: '500', marginBottom: '4px' }}>Drop components here</div>
    ...
    <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            ...
            <select
              ...
              onChange={(e) => setProp((props: ContainerBlockProps) => {
      ...
      <div className="space-y-3">
        ...
        {props.backgroundImage && (
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-xs text-gray-600 mb-1">Background Size</label>
              <select
            ...
            <div>
              <label className="block text-xs text-gray-600 mb-1">Background Repeat</label>
              <select

...
export const AccordionBlock: React.FC<AccordionBlockProps> = ({
  items = [
    { id: '1', title: 'Accordion Item 1', content: 'Content for accordion item 1', isOpen: false },
    { id: '2', title: 'Accordion Item 2', content: 'Content for accordion item 2', isOpen: false }
  ],
  allowMultiple = false,
  variant = 'default',
  size = 'md',
  ...
  const getItemStyles = (index: number) => {
    ...
    const baseStyles = {
      ...
      borderBottom: variant === 'default' && !isLast ? `1px solid ${borderColor}` : 'none'
    };
  ...
  const getHeaderStyles = (isOpen: boolean) => ({
    ...
    borderBottomLeftRadius: variant === 'separated' && !isOpen ? `${borderRadius}px` : '0',
    borderBottomRightRadius: variant === 'separated' && !isOpen ? `${borderRadius}px` : '0'
  });
  ...
  const getContentStyles = (isOpen: boolean) => ({
    ...
    borderBottomRightRadius: variant === 'separated' ? `${borderRadius}px` : '0'
  });
        ...
        return (
          <div key={item.id} style={getItemStyles(index)}>
            <div
              ...
              className={`${sizeClasses[size]} font-medium select-none hover:opacity-80`}
            >
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center space-x-2">
        <Switch
          ...
          onCheckedChange={(checked) => setProp((props: AccordionBlockProps) => props.allowMultiple = checked)}
        />
      ...
      <div>
        ...
        <Select value={props.variant} onValueChange={(value) => setProp((props: AccordionBlockProps) => props.variant = value as any)}>
          <SelectTrigger>
            <SelectValue />
          </SelectTrigger>
          <SelectContent>
      ...
      <div>
        ...
        <Select value={props.size} onValueChange={(value) => setProp((props: AccordionBlockProps) => props.size = value as any)}>
          <SelectTrigger>
            <SelectValue />
          </SelectTrigger>
          <SelectContent>
      ...
      <div>
        ...
        <Slider
          ...
          onValueChange={([value]) => setProp((props: AccordionBlockProps) => props.borderRadius = value)}
          max={50}
          step={1}
        />
      </div>
      ...
      <div>
        ...
        <Slider
          ...
          onValueChange={([value]) => setProp((props: AccordionBlockProps) => props.padding = value)}
          max={100}
          step={1}
        />
      </div>
      ...
      <div>
        <Label className="text-sm font-medium">Spacing: {props.spacing}px</Label>
        <Slider
          value={[props.spacing || 0]}
          onValueChange={([value]) => setProp((props: AccordionBlockProps) => props.spacing = value)}
          max={50}
          step={1}
        />
      </div>
      ...
      <div>
        ...
        <Slider
          ...
          onValueChange={([value]) => setProp((props: AccordionBlockProps) => props.animationDuration = value)}
          min={100}
          max={1000}
          step={50}
        />
      ...
      <div>
        ...
        <Input
          ...
          onChange={(e) => setProp((props: AccordionBlockProps) => props.backgroundColor = e.target.value)}
        />
      </div>
      ...
      <div>
        ...
        <Input
          ...
          onChange={(e) => setProp((props: AccordionBlockProps) => props.borderColor = e.target.value)}
        />
      </div>
      ...
      <div>
        ...
        <Input
          ...
          onChange={(e) => setProp((props: AccordionBlockProps) => props.headerBackgroundColor = e.target.value)}
        />
      </div>
      ...
      <div>
        ...
        <Input
          ...
          onChange={(e) => setProp((props: AccordionBlockProps) => props.headerTextColor = e.target.value)}
        />
      </div>
      ...
      <div>
        ...
        <Input
          ...
          onChange={(e) => setProp((props: AccordionBlockProps) => props.contentBackgroundColor = e.target.value)}
        />
      </div>
      ...
      <div>
        ...
        <Input
          ...
          onChange={(e) => setProp((props: AccordionBlockProps) => props.contentTextColor = e.target.value)}
        />
      </div>
      ...
      <div>
        ...
        <Input
          ...
          onChange={(e) => setProp((props: AccordionBlockProps) => props.iconColor = e.target.value)}
        />
      </div>
      ...
      <div>
        ...
        <Input
          value={props.width}
          onChange={(e) => setProp((props: AccordionBlockProps) => props.width = e.target.value)}

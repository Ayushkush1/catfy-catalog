...
export const VideoBlock: UserComponent<VideoBlockProps> = ({
  ...
  const renderVideo = () => {
    if (!src) {
      return (
        <div 
          className="flex flex-col items-center justify-center bg-gray-100 border-2 border-dashed border-gray-300"
          style={videoStyle}
        >
          <Upload className="w-12 h-12 text-gray-400 mb-2" />
          <p className="text-gray-500 text-sm">Add a video</p>
        </div>
      );
    }
      ...
      {selected && !src && (
        <div className="absolute inset-0 flex items-center justify-center bg-blue-50 bg-opacity-75">
          <div className="text-center">
            ...
            <p className="text-blue-600 text-sm font-medium">Click to configure video</p>
          </div>
        </div>
      )}
    </div>
      ...
      <div>
        ...
        <Select
          ...
          onValueChange={(value: string) =>
            setProp((props: VideoBlockProps) => (props.type = value as VideoBlockProps['type']))
          }
        >
          <SelectTrigger>
            <SelectValue />
      ...
      {props.type === 'upload' ? (
        ...
        <div>
          ...
          <Input
            ...
            placeholder={
              props.type === 'youtube' ? 'https://www.youtube.com/watch?v=...' :
              props.type === 'vimeo' ? 'https://vimeo.com/...' :
      ...
      <div className="grid grid-cols-2 gap-2">
        <div>
          ...
          <Input
            value={props.width}
            onChange={(e) =>
              setProp((props: VideoBlockProps) => (props.width = e.target.value))
            }
        ...
        <div>
          ...
          <Input
            value={props.height}
            onChange={(e) =>
              setProp((props: VideoBlockProps) => (props.height = e.target.value))
            }
      ...
      <div className="space-y-2">
        <div className="flex items-center space-x-2">
          <input
            ...
            onChange={(e) =>
              setProp((props: VideoBlockProps) => (props.controls = e.target.checked))
            }
            className="rounded"
          />
        ...
        <div className="flex items-center space-x-2">
          <input
            ...
            onChange={(e) =>
              setProp((props: VideoBlockProps) => (props.autoplay = e.target.checked))
            }
            className="rounded"
          />
        ...
        <div className="flex items-center space-x-2">
          <input
            ...
            checked={props.loop}
            onChange={(e) =>
              setProp((props: VideoBlockProps) => (props.loop = e.target.checked))
            }
            className="rounded"
          />
        ...
        <div className="flex items-center space-x-2">
          <input
            ...
            checked={props.muted}
            onChange={(e) =>
              setProp((props: VideoBlockProps) => (props.muted = e.target.checked))
            }
            className="rounded"
          />

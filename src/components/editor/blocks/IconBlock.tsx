...
const POPULAR_ICONS = [
  ...
  'Clock', 'Search', 'Settings', 'Menu', 'X', 'Check', 'ChevronRight',
  'ChevronLeft', 'ChevronUp', 'ChevronDown', 'ArrowRight', 'ArrowLeft',
  'ArrowUp', 'ArrowDown', 'Plus', 'Minus', 'Edit', 'Trash2', 'Download',
  'Upload', 'Share', 'Copy', 'Eye', 'EyeOff', 'Lock', 'Unlock', 'Shield',
  'AlertCircle', 'CheckCircle', 'XCircle', 'Info', 'HelpCircle', 'Zap',
  'Flame', 'Sun', 'Moon', 'Cloud', 'Umbrella', 'Car', 'Plane', 'Ship',
  'Camera', 'Image', 'Video', 'Music', 'Headphones', 'Mic', 'Volume2',
  'VolumeX', 'Play', 'Pause', 'Square', 'SkipBack', 'SkipForward',
  'Repeat', 'Shuffle', 'Wifi', 'WifiOff', 'Bluetooth', 'Battery',
  'BatteryLow', 'Signal', 'Smartphone', 'Laptop', 'Monitor', 'Printer',
  'Globe', 'Link', 'ExternalLink', 'Bookmark', 'Tag', 'Flag', 'Gift',
  'Award', 'Trophy', 'Target', 'Compass', 'Map', 'Navigation', 'Anchor'
];
    ...
    <div className="space-y-4">
      ...
      <div>
        ...
        <Input
          ...
          onChange={(e) =>
            setProp((props: IconBlockProps) => (props.backgroundColor = e.target.value))
          }
          className="mt-1"
        />
        <Button
          ...
          size="sm"
          onClick={() =>
            setProp((props: IconBlockProps) => (props.backgroundColor = 'transparent'))
          }
      ...
      <div>
        ...
        <Select
          ...
          onValueChange={(value: string) =>
            setProp((props: IconBlockProps) => (props.alignment = value as IconBlockProps['alignment']))
          }
        >
          <SelectTrigger>
            <SelectValue />
      ...
      <div>
        <Label htmlFor="icon-opacity">Opacity: {Math.round((props.opacity || 1) * 100)}%</Label>
        <Slider
      ...
      {props.href && (
        <div>
          ...
          <Select
            value={props.target}
            onValueChange={(value: string) =>
              setProp((props: IconBlockProps) => (props.target = value as IconBlockProps['target']))
            }
          >
            <SelectTrigger>
              <SelectValue />

    ...
    return (
        <div className="relative w-full h-screen overflow-hidden print:h-screen bg-white">
            ...
            <div className="flex h-full">
                ...
                <div className="w-1/2 flex flex-col items-center justify-center px-16 py-8 bg-[#eaddd455]">
                    {/* Contact Title */}
                    <h1 className="text-6xl text-center  mb-20 text-gray-900 tracking-wide">
                        CONTACT
                    </h1>
                    ...
                    <div className="space-y-8 text-center mb-20">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-800">
                                {profile.website || content?.profile?.website || 'www.maisonarte.com'}
                            </p>
                        </div>

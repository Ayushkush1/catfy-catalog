...
interface HomeDecorCatalogueTemplateProps {
    catalogue: Catalogue & {
...
export function HomeDecorCatalogueTemplate({
    catalogue,
    profile,
    themeColors,
    isEditMode,
    ...
    themeId
}: HomeDecorCatalogueTemplateProps) {
    ...
    return (
        <div
            className="home-decor-catalogue-template bg-gray-50"
            style={{
        ...
        >
            {/* Page 1: Cover Page - The Art of Living */}
            <CoverPage
                catalogue={catalogue}
                profile={profile}
            ...
            {/* Page 2: Intro Page - Living Through Details */}
            <IntroPage
                catalogue={catalogue}
                profile={profile}
                themeColors={{
                    ...
                    background: themeColors.background || '#f8f8f8',
            ...
            {/* Page 3: Product Category Page - Every Object a Story */}
            <ProductCategoryPage
                catalogue={catalogue}
                profile={profile}
                themeColors={themeColors}
            ...
            {/* Page 4: Contact Page - In Touch With Timelessness */}
            <ContactPage
                catalogue={catalogue}
                profile={profile}
                themeColors={themeColors}
...
export function HomeDecorCatalogueTemplateWrapper(props: TemplateComponentProps) {
    ...
    const themeColors = {
        ...
        background: theme.colors.background || '#f8f8f8',
        text: typeof theme.colors.text === 'string' ? theme.colors.text : theme.colors.text?.primary || '#2c2c2c'
    };

    return (
        <HomeDecorCatalogueTemplate
            catalogue={catalogue}
            profile={profile}
            themeColors={themeColors}
            {...otherProps}

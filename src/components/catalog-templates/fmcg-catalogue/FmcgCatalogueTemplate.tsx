...
interface FmcgCatalogueTemplateProps {
  catalogue: Catalogue & {
...
export function FmcgCatalogueTemplate({
  catalogue,
  profile,
  themeColors,
  isEditMode,
  ...
  return (
    <div
      className="fmcg-catalogue-template bg-black"
      style={{
...
export function FmcgCatalogueTemplateWrapper(props: TemplateComponentProps) {

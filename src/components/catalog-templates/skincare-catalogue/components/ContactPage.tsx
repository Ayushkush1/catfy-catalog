...
export function ContactPage({
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden print:h-screen">
      {/* Two column layout */}
      <div className="flex h-full">
        ...
        <div className='w-1/2 bg-[#1f1616] flex items-center justify-center'>
          <div className="flex flex-col items-center justify-center bg-[#f9ede8] px-16 py-6 rounded-lg max-w-md w-full mx-8">
            {/* Contact Title */}
            <h1 className="text-4xl text-center font-light mb-12 text-[#B33B15] tracking-wide" style={{ fontFamily: 'serif' }}>
              Get in Touch
            </h1>
            ...
            <div className="flex space-x-4 mb-8">
              ...
              {content?.catalogue?.settings?.socialMedia?.instagram && (
                <a
                  ...
                  className="w-10 h-10 bg-[#B33B15] rounded-full flex items-center justify-center hover:bg-gray-700 transition-colors"
                >
